export const categoryList = {
  data: [
    ...
    },
    {
      id: 18,
      name: '생활',
      imageUrl: 'https://i.ibb.co/T0mnp8m/kitchen.png',
    },
    {
      id: 19,
      name: '가공식품',
    ...
    { id: 20, name: '식물', imageUrl: 'https://i.ibb.co/rwZhRqh/plant.png' },
    {
      id: 21,
      name: '기타 중고물품',
      imageUrl: 'https://i.ibb.co/tCyMPf5/etc.png',
    },
    { id: 22, name: '삽니다', imageUrl: 'https://i.ibb.co/g7Gc1w0/buy.png' },
  ],
};
